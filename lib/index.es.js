import { defineComponent as p, useCssVars as c, computed as h, createElementBlock as d, openBlock as r, renderSlot as m, createElementVNode as v, Fragment as L, renderList as g, normalizeStyle as a } from "vue";
const X = { class: "el-tree-line" }, y = /* @__PURE__ */ p({
  __name: "ElTreeLine",
  props: {
    node: {},
    indent: { default: 18 },
  ...
  setup(l) {
    c((e) => ({
      "305e3e3a": e.lineConfig.width,
      "302b2e25": e.lineConfig.style,
      "2f473fd7": e.lineConfig.color,
      "2330af9e": e.radius
    }));
    const s = l, i = h(() => {
      const { node: e } = s, t = [];
  ...
  for (const [e, t] of s)
    i[e] = t;
  return i;
}, f = /* @__PURE__ */ C(y, [["__scopeId", "data-v-9f362756"]]);
